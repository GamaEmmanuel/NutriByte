...
public class Female extends Person {
	...
	float calculateEnergyRequirement() {
		...
		else if ( ageGroup.getAgeGroupIndex()==1) {
			float a =  (float)(89 * weight - 44);
			return a; 
		}
		else if ( ageGroup.getAgeGroupIndex()==2) {
			float a =  (float)(89 * weight - 78);
			return a; 
		}
		else if (ageGroup.getAgeGroupIndex()==3) {
			float a =  (float)(89 * weight - 80);
			return a; 
		}

		else if (ageGroup.getAgeGroupIndex()== 4 || ageGroup.getAgeGroupIndex() == 5
				|| ageGroup.getAgeGroupIndex()==6) {
			float a =  (float)(135.3 - (30.8 * this.age) + this.physicalActivityLevel * (10 * this.weight + 934 * this.height / 100) + 20);
			return a; 
		}
		
		else  {
			float a = (float)(354 - (6.91 * this.age) + this.physicalActivityLevel * (9.36 * this.weight + 726 * this.height / 100)); 
			return a; 
		}
	...
	void initializeNutriConstantsTable() {
		//write your code here
		super.nutriConstantsTable = nutriConstantsTableFemale ;
